...
`}
        ...
        <Paragraph>
          <ul className="list-disc list-inside">
            ...
            <li>
              <strong>initialValue</strong> — початкове значення (буде
              використане лише на першому рендері)
            </li>
          </ul>
        </Paragraph>
...
setCount(count + 1);`}
        />
        <Paragraph>
          — обидва використають одне й те саме значення count → результат буде
          +1, а не +2.
          <br />
          <br />
          Рішення:
        ...
        <Paragraph>
          Навіщо це потрібно? Коли твій початковий стан вимагає важких
          розрахунків (наприклад, парс JSON, локальне збереження, fetch з
          localStorage). <br />
          <br />
